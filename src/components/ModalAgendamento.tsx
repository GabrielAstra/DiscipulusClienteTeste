...
export default function ModalAgendamento({ professor, aberto, aoFechar }: PropriedadesModalAgendamento) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="px-6 py-4 border-b border-gray-200">
          <div className="flex items-center space-x-4">
            <div className={`flex items-center space-x-2 ${passo >= 1 ? 'text-indigo-600' : 'text-gray-400'}`}>
            ...
            <div className={`flex items-center space-x-2 ${passo >= 2 ? 'text-indigo-600' : 'text-gray-400'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
            ...
            <div className="flex-1 h-px bg-gray-200"></div>
            <div className={`flex items-center space-x-2 ${passo >= 3 ? 'text-indigo-600' : 'text-gray-400'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    >
                      <option value={30}>30 minutos - R${(professor.valorHora * 0.5).toFixed(2)}</option>
                      <option value={60}>1 hora - R${professor.valorHora}</option>
                      <option value={90}>1h 30min - R${(professor.valorHora * 1.5).toFixed(2)}</option>
                      <option value={120}>2 horas - R${(professor.valorHora * 2).toFixed(2)}</option>
                    </select>
                  </div>
                ...
                <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                  ...
                  <div className="space-y-1 text-sm text-gray-600">
                    <p><span className="font-medium">Data:</span> {new Date(dataSelecionada).toLocaleDateString('pt-BR', { weekday: 'long', day: 'numeric', month: 'long', year: 'numeric' })}</p>
                    <p><span className="font-medium">Horário:</span> {horarioSelecionado}</p>
                    <p><span className="font-medium">Duração:</span> {duracao} minutos</p>
                    <p><span className="font-medium">Professor:</span> {professor.nome}</p>
              ...
              <div>
                ...
                <div className="p-4 bg-indigo-50 rounded-lg border border-indigo-200">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-2xl font-bold text-indigo-600">R${precoTotal.toFixed(2)}</span>
                  </div>
